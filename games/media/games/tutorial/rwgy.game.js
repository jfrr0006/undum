...
/* Las situaciones en las que puede estar el juego. Cada uno tiene un identificador único. */
undum.game.situations = {
    start: new undum.SimpleSituation(
        "<h1>Recepcionista en el lobby:</h1>\
        <img src='media/games/tutorial/woodcut1rwby1.1.png' class='float_right'>\
        <p>&iexcl; ENHORABUENA ! \n\
           Has sido aceptado/a en la maravillosa y magistral academia \n\
           de Beacon, &iexcl;justo como quer&iacute;as! Aqu&iacute; comenzar&aacute;s a entrenarte como un aut&eacute;ntico \n\
           cazador, o cazadora, siempre dispuesto a derrotar a los Grimms y echar una mano \n\
           a quien lo necesite.</p>\
        \
        <p>&iquest;C&oacute;mo? &iquest;Qu&eacute; no sabes que es un Grimm? \n\
           ...
           <img src='media/games/tutorial/yaguara.png' >\n\
           </p>\
        \
        <p>&iquest;Terror&iacute;fico verdad? &iexcl;Por eso debes entrenarte! Para plantar cara \n\
           a aquellos que osen poner en peligro a cualquier persona de nuestra sociedad. \n\
           </p>\
        \
         Pero lo primero es lo primero, &iquest;qu&eacute; tal si te das una peque&ntilde;a vuelta\n\
         por la academia? Seguro que te viene de maravilla para no perderte luego. \n\
         &iexcl;Cuando termines de explorar recuerda pasarte por el Hall Principal! El mism&iacute;simo\n\
         director en persona dar&aacute; una primera charla sobre la formaci&oacute;n de los equipos\n\
         y te asignar&aacute; a tus primeros compa&ntilde;eros. </p>\
         \
        <p class='transient'>Click <a href='hub'> para continuar... </a></p>"
    ),
    
/*Aqui le meto la situacion de topics */
    ...
    situations: new undum.Situation({
        ...
        tags: ["topic"],
        optionText: "Ir a la biblioteca",                             /*Aqui va la opción 1*/
        displayOrder: 1
    }),    
