...
undum.game.situations = {
    start: new undum.SimpleSituation(
        ...
        \
        \n\
        <p>&iquest;C&oacute;mo? &iquest;Qu&eacute; no sabes que es un <a href='rooms'>Grimm</a>?\
    ...
    situations: new undum.Situation({
        ...
        tags: ["topic"],
        optionText: "Visitar tu dormitorio",                             /*Aqui va la opción 1*/
        displayOrder: 1
    }),
